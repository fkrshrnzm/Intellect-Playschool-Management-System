...
<div id="wrapper">
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        ...
        <div class="sidebar-brand-icon "><img src="img/lLogo.png" style="width: 30px; height: 50px;"></div>
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item"><a class="nav-link active" href="teacher_announcement.php"><i class="far fa-user-circle"></i><span>Announcement</span></a></li>
    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container py-4 py-xl-5">
                ...
                <div style="text-align: left;padding-bottom: 20px;"><button class="btn btn-success" type="button" style="height: 47px;" data-bs-target="#modal-1" data-bs-toggle="modal"><svg class="bi bi-plus-circle" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path>
                            <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"></path>
                        </svg> &quot; Create an Announcement &quot;</button>
                </div>
                <div class="row gy-4 row-cols-1 row-cols-md-2 row-cols-xl-3">
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                        ...
                        if(($row["announce_Type"] == '1') && ($row["announce_Category"] == '0' || $row["announce_Category"] == '1' || $row["announce_Category"] == '2' ))
                        {
                            ...
                            echo' <button style="margin-right: 10px; " class="btn btn-warning" value="Submit" type="button" onclick="location.href=\'modifyannouncementteacher.php?aa_id='.$row['announce_ID'].'\'">Modify</button>';
                            echo'</div>';
                            echo'</form>';
                            echo'</div>';
                            echo'</div>';
            ...
            <?php include('createAnnTeachermodal.php'); ?>
            <script>
              function confirmDelete(aa_id) {
                Swal.fire({
                  ...
                  if (result.value) {
                    window.location.href = 'deleteannouncementteacher.php?aa_id=' + aa_id;
                  }
                });
    ...
    <a class="d-inline border rounded scroll-to-top" href="#page-top"><i class="fas fa-angle-up"></i></a>
</div>
            </div>
</div>
